...
# author:    https://github.com/sighsmile/conlleval/blob/master/conlleval.py
# version:   2017-05-18

# author:    eric.wtlin@gmail.com
# note:      support online evaluation; add input format transformation; bug fix
...
def bioes2bio(tags):
    """ BIOES -> BIO
    CAUTION:
        For BIOES, if the model predict "BIIO", the result will be considered as "BIEO" in this way
    """
    new_tags = []
